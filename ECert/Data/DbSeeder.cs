...
public static class DbSeeder
{
    public static void Seed(ECertDbContext db)
    {
        ...
        {
            new() { CourseName = "التمريض المنزلي", ShortDescription = "دورة شاملة في أساسيات التمريض والرعاية المنزلية", FullDescription = "دورة تدريبية شاملة تغطي جميع أساسيات التمريض المنزلي包括 رعاية المرضى وكبار السن", Objectives = "إتقان أساسيات التمريض المنزلي\nالتعامل مع الحالات الطارئة\nرعاية كبار السن", CategoryId = categories[0].CategoryId, InstructorId = instructors[0].InstructorId, StartDate = DateTime.Now.AddDays(7), EndDate = DateTime.Now.AddDays(37), Location = "الرياض - حي النخيل", Price = 500, TotalSeats = 25, Status = "OpenForRegistration", IsFeatured = true },
            new() { CourseName = "تطوير تطبيقات الويب", ShortDescription = "تعلم بناء تطبيقات ويب حديثة", FullDescription = "دورة متكاملة في تطوير تطبيقات الويب باستخدام أحدث التقنيات", Objectives = "بناء تطبيقات ويب كاملة\nفهم قواعد البيانات\nالنشر على الإنترنت", CategoryId = categories[1].CategoryId, InstructorId = instructors[1].InstructorId, StartDate = DateTime.Now.AddDays(14), EndDate = DateTime.Now.AddDays(60), Location = "أونلاين", Price = 800, TotalSeats = 30, Status = "OpenForRegistration", IsFeatured = true },
            new() { CourseName = "القيادة الإدارية الفعالة", ShortDescription = "برنامج تطوير المهارات القيادية", FullDescription = "برنامج مكثف لتطوير المهارات القيادية والإدارية", Objectives = "تطوير مهارات القيادة\nإدارة الفرق\nاتخاذ القرارات", CategoryId = categories[2].CategoryId, InstructorId = instructors[2].InstructorId, StartDate = DateTime.Now.AddDays(21), EndDate = DateTime.Now.AddDays(42), Location = "جدة - حي الروضة", Price = 1200, TotalSeats = 20, Status = "Published", IsFeatured = false }
        };
